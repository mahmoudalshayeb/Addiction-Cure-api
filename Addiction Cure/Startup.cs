...
namespace Addiction_Cure
{
    public class Startup
    {
        ...
        {
            StripeConfiguration.ApiKey = Configuration.GetSection("Stripe")["rk_test_51MbSgMC5iNj1HcZ7ItLfCuiKXaB6qlFOlZkld3KXhKTRFayACfrLVwbkOchYwi7NRvSemjMrBV564PcKyykADKHy00WZwYqDEx"];
